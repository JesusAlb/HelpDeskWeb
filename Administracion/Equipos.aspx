                                                                        ...
                                                                        <asp:Panel runat="server" CssClass="panel-heading text-center">
                                                                            ...
                                                                            <asp:Panel runat="server" CssClass="col-lg-4">
                                                                                <asp:Label runat="server" Text="Procesador" Font-Bold="true"></asp:Label><asp:Panel runat="server" CssClass="input-group">
                                                                                    <asp:TextBox runat="server" ID="txtProcesador"  CssClass="form-control" MaxLength="4" onpaste="return false;" onkeyup="validateDecimal(this);" />
                                                                                    <span class="input-group-addon">GHZ</span> </asp:Panel></asp:Panel><asp:Panel runat="server" CssClass="col-lg-4">
                                                                                <asp:Label runat="server" Text="Memoria RAM" MaxLength="4" Font-Bold="true" onpaste="return false;"></asp:Label><asp:Panel runat="server" CssClass="input-group">
                                                                                    <asp:TextBox runat="server" ID="txtRAM" CssClass="form-control" MaxLength="4" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isNumeric(event.keyCode);" />
                                                                                ...
                                                                                <asp:Label runat="server" Text="Almacenamiento" Font-Bold="true"></asp:Label><asp:Panel runat="server" CssClass="input-group">
                                                                                    <asp:TextBox runat="server" ID="txtDD" CssClass="form-control" MaxLength="4" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isNumeric(event.keyCode);"/>
                                                                    ...
                                                                    <asp:Panel runat="server" CssClass="col-lg-6">
                                                                        <asp:Panel runat="server" CssClass="panel panel-default" ID="panelEquipo">
                                                                            <asp:Panel runat="server" CssClass="panel-heading">
                                                                                ...
                                                                                <asp:Panel runat="server" CssClass="form-group">
                                                                                    <asp:Panel runat="server" CssClass="input-group">
                                                                                        <span runat="server" class="input-group-addon">Serie</span> <asp:TextBox runat="server" ID="txtSerieEquipo" onpaste="return false;" MaxLength="20" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" CssClass="form-control mayusculas" required></asp:TextBox></asp:Panel></asp:Panel></asp:Panel></asp:Panel></asp:Panel><asp:Panel runat="server" CssClass="col-lg-6">
                                                                    ...
                                                                    <asp:Panel runat="server" CssClass="col-lg-6">
                                                                        <asp:Panel runat="server" CssClass="panel panel-default" ID="panelTeclado">
                                                                            <asp:Panel runat="server" CssClass="panel-heading">
                                                                                ...
                                                                                <asp:Panel runat="server" CssClass="form-group">
                                                                                    <asp:Panel runat="server" CssClass="input-group">
                                                                                        <span runat="server" class="input-group-addon">Serie</span> <asp:TextBox runat="server" ID="txtSerieTeclado" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="20" CssClass="form-control mayusculas" required></asp:TextBox></asp:Panel></asp:Panel></asp:Panel></asp:Panel></asp:Panel><asp:Panel runat="server" CssClass="col-lg-6">
                                                                        <asp:Panel runat="server" CssClass="panel panel-default" ID="panelMouse">
                                                                            <asp:Panel runat="server" CssClass="panel-heading">
                                                                                ...
                                                                                <asp:Panel runat="server" CssClass="form-group">
                                                                                    <asp:Panel runat="server" CssClass="input-group">
                                                                                        <span runat="server" class="input-group-addon">Serie</span> <asp:TextBox runat="server" ID="txtSerieMouse" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="20" CssClass="form-control mayusculas" required></asp:TextBox></asp:Panel></asp:Panel></asp:Panel></asp:Panel></asp:Panel></asp:Panel></asp:Panel><asp:Panel runat="server" CssClass="form-group">
                                                                <asp:Panel runat="server" CssClass="row">
                                                                                ...
                                                                                <asp:Panel runat="server" CssClass="row">
                                                                                    ...
                                                                                    <asp:Panel runat="server" CssClass="col-lg-8">
                                                                                        <asp:Label runat="server" Text="Dirección IP" Font-Bold="true"></asp:Label><asp:Panel runat="server" CssClass="input-group">
                                                                                            <asp:TextBox runat="server" ID="txtIP1" CssClass="form-control" onkeyup="keyUP(event.keyCode)" onpaste="return false;" onkeydown="return isNumeric(event.keyCode);" maxlength="3" />
                                                                                            <span runat="server" class="input-group-addon">.</span> <asp:TextBox runat="server" ID="txtIP2" onpaste="return false;" CssClass="form-control" onkeyup="keyUP(event.keyCode)" onkeydown="return isNumeric(event.keyCode);" MaxLength="3"  />
                                                                                            <span runat="server" class="input-group-addon">.</span> <asp:TextBox runat="server" ID="txtIP3" onpaste="return false;" CssClass="form-control" onkeyup="keyUP(event.keyCode)" onkeydown="return isNumeric(event.keyCode);" MaxLength="3"  />
                                                                                            <span runat="server" class="input-group-addon">.</span> <asp:TextBox runat="server" ID="txtIP4" onpaste="return false;" CssClass="form-control" onkeyup="keyUP(event.keyCode)" onkeydown="return isNumeric(event.keyCode);" MaxLength="3"  />
                                                                                        </asp:Panel>
                                                                                    </asp:Panel>
                                                                                    <asp:Panel runat="server" CssClass="col-lg-2"></asp:Panel>
                                                                                </asp:Panel>
                                                                                ...
                                                                                <asp:Panel runat="server" CssClass="row">
                                                                                    ...
                                                                                    <asp:Panel runat="server" CssClass="col-lg-8">
                                                                                        <asp:Label runat="server" Text="Dirección MAC" Font-Bold="true"></asp:Label><asp:Panel runat="server" CssClass="input-group">
                                                                                            <asp:TextBox runat="server" ID="txtMAC1" CssClass="form-control mayusculas" onkeyup="keyUP(event.keyCode)" onpaste="return false;" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="2" />
                                                                                            <span runat="server" class="input-group-addon">-</span> <asp:TextBox runat="server" ID="txtMAC2" CssClass="form-control mayusculas" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="2" />
                                                                                            <span runat="server" class="input-group-addon">-</span> <asp:TextBox runat="server" ID="txtMAC3" CssClass="form-control mayusculas" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="2" />
                                                                                            <span runat="server" class="input-group-addon">-</span> <asp:TextBox runat="server" ID="txtMAC4" CssClass="form-control mayusculas" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="2" />
                                                                                            <span runat="server" class="input-group-addon">-</span> <asp:TextBox runat="server" ID="txtMAC5" CssClass="form-control mayusculas" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="2" />
                                                                                            <span runat="server" class="input-group-addon">-</span> <asp:TextBox runat="server" ID="txtMAC6" CssClass="form-control mayusculas" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlphaNumeric(event.keyCode);" MaxLength="2" />
                                                                                        </asp:Panel>
                                                                                    </asp:Panel>
                                                                                    <asp:Panel runat="server" CssClass="col-lg-2"></asp:Panel>
                                                                                </asp:Panel>
