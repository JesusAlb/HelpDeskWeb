        ...
        <asp:Panel runat="server" CssClass="box">
            <form runat="server">
                ...
                <asp:Panel runat="server" CssClass="row panel-titulo">
                    Centro de atención a eventos </asp:Panel><asp:Panel runat="server" CssClass="row">
                        ...
                        <asp:Panel runat="server" CssClass="col-lg-7">
                            ...
                            <asp:Panel runat="server" CssClass="col-lg-11">
                                ...
                                <asp:Panel runat="server" CssClass="row" Style="margin-top: 2%">
                                    <asp:Panel runat="server" CssClass="input-group">
                                        <span class="input-group-addon">Filtrar por fecha</span> <asp:TextBox runat="server"   TextMode="Date" ID="txtFechaInicial" CssClass="form-control"></asp:TextBox><span class="input-group-addon">a</span> <asp:TextBox runat="server" TextMode="Date"  ID="txtFechaFinal" CssClass="form-control"></asp:TextBox></asp:Panel></asp:Panel></asp:Panel></asp:Panel><asp:Panel runat="server" CssClass="col-lg-4">
                                                ...
                                                <ContentTemplate>
                                                    <asp:Panel runat="server" CssClass="row">
                                                        <asp:Panel runat="server" CssClass="btn-group btn-group-justified">
                                                            <asp:LinkButton ID="btnNuevo" OnClientClick="mostrarModal('ModalNuevo')" OnClick="btnNuevo_Click" runat="server" CssClass="btn btn-primary">
                            <span class="glyphicon glyphicon-plus-sign"></span>
                             Nuevo
                                                            </asp:LinkButton><asp:LinkButton ID="btnEditar" OnClick="btnEditar_Click" OnClientClick="mostrarModal('ModalNuevo')" runat="server" CssClass="btn btn-primary">
                            <span class="glyphicon glyphicon-plus-sign"></span>
                             Editar
                            ...
                            <span class="glyphicon glyphicon-remove"></span>
                             Cancelar
                                                    ...
                                                    <asp:Panel runat="server" CssClass="row" Style="margin-top: 2%">
                                                        <asp:Panel runat="server" CssClass="btn-group btn-group-justified">
                                                            <asp:LinkButton ID="btnAsignar" OnClientClick="mostrarModal('ModalAsignar')" runat="server" CssClass="btn btn-primary">
                            <span class="glyphicon glyphicon-user"></span>
                             soporte
                                                            </asp:LinkButton><asp:LinkButton ID="btnRecursos" OnClientClick="mostrarModal('ModalRecursos')" OnClick="btnRecursos_Click" runat="server" CssClass="btn btn-primary">
                                                        ...
                                                        <asp:Panel runat="server" CssClass="modal-body">
                                                            <asp:Panel runat="server" CssClass="row">
                                                                ...
                                                                <asp:Panel runat="server" CssClass="col-lg-10">
                                                                    <asp:UpdatePanel runat="server" ID="updateModalNuevo" UpdateMode="Conditional"><ContentTemplate>
                                                ...
                                                <asp:Panel runat="server" CssClass="modal-dialog modal-lg">
                                                    <asp:Panel runat="server" CssClass="modal-content">
                                                        ...
                                                        <asp:Panel runat="server" CssClass="modal-body">
                                                            <asp:Panel runat="server" CssClass="row">
                                                                ...
                                                                <asp:Panel runat="server" CssClass="row" Style="margin-top: 2%">
                                                                    ...
                                                                    <asp:Panel runat="server" CssClass="col-lg-5">
                                                                        <asp:Panel runat="server" CssClass="form-group">
                                                                            <asp:Panel runat="server" CssClass="input-group">
                                                                                <asp:Label runat="server" CssClass="input-group-addon">Título</asp:Label><asp:TextBox runat="server" CssClass="form-control" ID="txtTitulo" ReadOnly="true" Style="resize: none" TextMode="MultiLine"></asp:TextBox>
                                                                            </asp:Panel>
                                                                        </asp:Panel>
                                                                    </asp:Panel>
                                                                    <asp:Panel runat="server" CssClass="col-lg-1"></asp:Panel>
                                                            ...
                                                            <asp:Panel runat="server" CssClass="row">
                                                                <asp:Panel runat="server" CssClass="col-lg-6">
                                                                    <asp:Panel runat="server" ID="panelRecursosAsignados" CssClass="form-group" ScrollBars="Auto" Height="250" Style="margin-top: 1%">
                                                                        <asp:UpdatePanel runat="server" ID="UpdatePanelRecursosAsignados" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:GridView ToolTip="Tabla de recursos asignados" runat="server" OnRowCreated="gvEventos_RowCreated" ID="gvRecursosAsignados" Style="margin: 1% 1% 1% 1%" AutoGenerateColumns="False" CssClass="table table-bordered" SelectedRowStyle-ForeColor="black" SelectedRowStyle-BackColor="#B0C4DE"
                                                                                    AlternatingRowStyle-BackColor="#e0e0e0" ShowHeaderWhenEmpty="true" DataKeyNames="idRequerimientos" CellPadding="4" GridLines="Horizontal">
                                                            ...
                                                            Quitar
                                                                        </asp:LinkButton></asp:Panel></asp:Panel><asp:Panel runat="server" CssClass="col-lg-6">
                                                                    <asp:Panel runat="server" ID="panelRecursosNoAsignados" CssClass="form-group" ScrollBars="Auto" Height="250" Style="margin-top: 1%">
                                                                        <asp:UpdatePanel runat="server" ID="UpdateRecursosNoAsignados" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <asp:GridView ToolTip="Tabla de recursos disponibles" runat="server" ShowHeaderWhenEmpty="true" OnRowCreated="gvEventos_RowCreated" ID="gvRecursosNoAsignados" Style="margin: 1% 1% 1% 1%" AutoGenerateColumns="False" CssClass="table table-bordered" SelectedRowStyle-ForeColor="black" SelectedRowStyle-BackColor="#B0C4DE"
                                                                                    AlternatingRowStyle-BackColor="#e0e0e0" DataKeyNames="idRequerimientos" CellPadding="4" GridLines="Horizontal">
                                                                                    <HeaderStyle Font-Bold="True" ForeColor="White" BackColor="#006699" Font-Size="12" />
                                                                                    <Columns>
                                                                                        <asp:BoundField HeaderText="Recurso" DataField="nomRequerimiento" />
                                                                                    </Columns>
                                                            ...
                                                            <span class="glyphicon glyphicon-plus-sign"></span>
                                                            Añadir
                                                                        </asp:LinkButton></asp:Panel></asp:Panel></asp:Panel></asp:Panel><asp:Panel runat="server" CssClass="modal-footer">
                                                            <asp:Button runat="server" CssClass="btn btn-default" data-dismiss="modal" Text="Cerrar" />
