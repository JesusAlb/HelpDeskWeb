                                                                    ...
                                                                    <asp:Panel runat="server" CssClass="row">
                                                                        ...
                                                                        <asp:Panel runat="server" CssClass="col-lg-10">
                                                                            <asp:Panel runat="server" ID="panelNombre" CssClass="form-group">
                                                                                ...
                                                                                <asp:TextBox runat="server" ID="txtNombre" onpaste="return false;" onkeyup="keyUP(event.keyCode)" onkeydown="return isAlpha(event.keyCode);" MaxLength="30" CssClass="form-control" placeholder="Nombre" />
                                                                            </asp:Panel>
