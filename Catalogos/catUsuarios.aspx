<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="catUsuarios.aspx.cs" Inherits="HelpDeskWeb.Catalogos.WebForm1" %>
          ...
          <ul class="nav navbar-nav">       
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu" role="menu">
                <li class="active"><asp:HyperLink runat="server" NavigateUrl="~/Catalogos/catUsuarios.aspx" >Para usuarios</asp:HyperLink></li>
