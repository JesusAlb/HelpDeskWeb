            ...
            <form id="form1" runat="server">               
                ...
                <asp:Panel runat="server" CssClass="row">
                    ...
                    <asp:Panel runat="server" CssClass="col-lg-8">
                        ...
                        <asp:LinkButton ID="btnNuevo" runat="server" CssClass="btn btn-primary" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus-sign"></span> Nuevo</asp:LinkButton>
                            <!-- Modal -->
                                            ...
                                            <asp:Panel runat="server" CssClass="row">
                                                ...
                                                <asp:Panel runat="server" CssClass="col-lg-10">
                                                    <asp:UpdatePanel runat="server" ID="update1" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Panel runat="server" role="form">
                                                                ...
                                                                <asp:Panel runat="server" CssClass="form-group">
                                                                    <asp:Panel runat="server" CssClass="row">
                                                                        ...
                                                                        <asp:Panel runat="server" CssClass="col-lg-6">
                                                                            ...
                                                                            <asp:TextBox runat="server" ID="txtExtension" TextMode="Number" CssClass="form-control" />
                                                                        </asp:Panel>
                                                                    </asp:Panel>
                                                                </asp:Panel>
                                                                <asp:Panel runat="server" CssClass="form-group">
                            ...
                            <asp:LinkButton runat="server" CssClass="btn btn-primary" data-toggle="modal" data-target="#myModal" ID="btnModificar" OnClick="btnModificar_Click">
                    ...
                    <asp:Panel runat="server" CssClass="row">
                        ...
                        <asp:UpdatePanel runat="server" ID="update2" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Panel runat="server" ID="ContenedorTabla" ScrollBars="Auto">
                                    <asp:GridView ToolTip="Seleccione el registro a modificar" OnRowCreated="gvUsuarios_RowCreated" runat="server" ID="gvUsuarios" AutoGenerateColumns="False" CssClass="table table-bordered" SelectedRowStyle-ForeColor="black" SelectedRowStyle-BackColor="#99ccff"
                                         AlternatingRowStyle-BackColor="#e0e0e0" DataKeyNames="idUsuario" CellPadding="4" GridLines="Horizontal" OnSelectedIndexChanged="gvUsuarios_SelectedIndexChanged" >
